...
describe('ConversationEngine tests', () => {
  ...
  it('Test multi-instance', () => {
    let conversation1 = new ConversationEngine(troubleshootingJSON)
    let conversation2 = new ConversationEngine(troubleshootingJSON)
    testUnfinishedConversation(conversation1)
    testUnfinishedConversation(conversation2)
    expect(conversation1.reply('Yes')).toBe(`Contact our customer support for more help.`)
    expect(conversation2.reply('Yes')).toBe(`Contact our customer support for more help.`)
  })
